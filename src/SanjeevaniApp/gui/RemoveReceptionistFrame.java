...
public class RemoveReceptionistFrame extends javax.swing.JFrame {
   ...
   /* public void clearText()
    {
    jcbRId.setSelectedIndex(0);
    
 }*/
 public void loadRCPTID(){
        try{
             rc=ReceptionistDao.getAllRcptId();
            for(String str:rc)
            {
                jcbRId.addItem(str);
            }
    ...
    private void initComponents() {
        ...
        jDesktopPane1.setLayer(jcbRId, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jDesktopPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        .addComponent(jcbRId, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        try{
        boolean rs=ReceptionistDao.RemoveRcpt((String)jcbRId.getSelectedItem());
            if(rs==true)
        {
